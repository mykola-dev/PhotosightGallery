...
fun DebugView() {
    ...
    val thumb =
            "https://cdn77-pic.xnxx-cdn.com/videos/thumbs169lll/d6/86/2f/d6862f3667e6eeeec1d468364b47ab59/d6862f3667e6eeeec1d468364b47ab59.17.jpg"
            ...
            SubcomposeAsyncImage(
                ...
                val placeholder =
                        painter.imageLoader
                                .memoryCache
                                ?.get(
                                        MemoryCache.Key(placeholderKey)
                                ) // should be cached but it's null
                                ?.bitmap
                                ?.asImageBitmap()
                    ...
                    is AsyncImagePainter.State.Loading -> {
                        if (placeholder != null)
                                Image(
                                        placeholder,
                                        null
                                ) // should show placeholder for a while but it's empty
